...
export const LoginPage = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "day") {
      ...
      if (selected && !isDateAllowed(selected.date)) {
        alert("You are not authorized to fill the form for a future day.");
  ...
  const handleSubmit = (e) => {
    ...
    // Proceed to next page or save data
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4 bg-gray-900 p-6 rounded-lg shadow-md">
        <div>
        ...
        <div>
          <label className="block mb-1 text-sm text-gray-400">Register Number</label>
          <input
            type="text"
            name="reg"
            className="w-full p-2 rounded bg-gray-800 text-white"
        ...
        <div>
          <label className="block mb-1 text-sm text-gray-400">Department</label>
          <input
            type="text"
            name="dept"
            className="w-full p-2 rounded bg-gray-800 text-white"
        ...
        <div>
          <label className="block mb-1 text-sm text-gray-400">Select Day</label>
          <select
            name="day"
            className="w-full p-2 rounded bg-gray-800 text-white"
            value={formData.day}
