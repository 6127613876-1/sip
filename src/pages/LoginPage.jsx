...
//   // Day options with actual dates
//   const dayOptions = [
//     { label: "Day 1 - 05.08.2025", value: "Day 1", date: "2025-08-05" },
//     { label: "Day 2 - 06.08.2025", value: "Day 2", date: "2025-08-06" },
//     { label: "Day 3 - 07.08.2025", value: "Day 3", date: "2025-08-07" },
//     { label: "Day 4 - 08.08.2025", value: "Day 4", date: "2025-08-08" }
//   ];
...
//     // If the day dropdown is being changed
//     if (name === 'day') {
...
//           alert("You are not authorized to access this future day.");
...
//         <div className="mb-6">
//           <label className="block font-semibold">Select Day</label>
//           <select
//             name="day"
//             value={formData.day}
//             onChange={handleChange}
...
export const LoginPage = () => {
  ...
  const dayOptions = [
    { label: 'Day 1 - 05.08.2025', value: 'Day 1', date: new Date('2025-08-05') },
    { label: 'Day 2 - 06.08.2025', value: 'Day 2', date: new Date('2025-08-06') },
    { label: 'Day 3 - 07.08.2025', value: 'Day 3', date: new Date('2025-08-07') },
    { label: 'Day 4 - 08.08.2025', value: 'Day 4', date: new Date('2025-08-08') }
  ];
  ...
  const isDateValid = (selectedDay) => {
    const selected = dayOptions.find(day => day.value === selectedDay);
  ...
  const handleSubmit = (e) => {
    ...
    if (!isDateValid(formData.day)) {
      setError('You are not authorized to access this day yet.');
      return;
    }
    ...
    // Navigate to the correct feedback form
    if (formData.day === 'Day 1') {
      navigate('/day1');
    } else if (formData.day === 'Day 2') {
      navigate('/day2');
    } else if (formData.day === 'Day 3') {
      navigate('/day3');
    } else if (formData.day === 'Day 4') {
      navigate('/day4');
    }
  };
        ...
        <div className="mb-4">
          ...
          >
            ...
            {dayOptions.map((day) => (
              ...
              >
                {day.label} {day.date > today ? '(Not Available)' : ''}
              </option>
            ))}
          </select>
        </div>
